        ...
        case "+":
          ...
          regexreply.parse(line, function(regexp) {
            ...
            if (miniTopic.isPrevious !== null) {
              ...
              regexreply.parse(miniTopic.isPrevious, function(prevParse) {
        ...
        case "-":
          if (currentTrigger === null && !isConditional) {
            ...
            for(var convo in convos) {
              if (convo === isConditional) {
                convos[convo].gambits.push(gambitId);
              }
            }
          }
        ...
        case '>':
          ...
          if (type === "pre" || type === "post") {
            ...
            for (var j = 0; j < keywords.length; j++) {
              topics[name].keywords.push(keywords[j]);
            }
